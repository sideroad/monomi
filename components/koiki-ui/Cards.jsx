...
const Cards = ({
  ...
  >
    {items.map(item => (
      <li key={item.id} className={styles.cards.item}>
        <button
        ...
        >
          <div className={styles.cards.back} style={{ backgroundImage: `url(${item.image})` }} />
          <div className={`${styles.cards.outline} ${item.title ? '' : styles.cards.none}`} />
          {item.title ? (
            <div
